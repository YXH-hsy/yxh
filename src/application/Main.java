...
public class Main{
	 ...
	 * */
	 ...
	 // 创建静态父窗口方便其他文件引用	
	 public static JFrame f = new JFrame("模拟记事本 ");	
	 // 使用swing框架的文本域，awt的组件会屏蔽下拉框
	 public static JTextArea ta = new JTextArea();  
	 
	 // 添加打开和保存文件的对话框
	 public FileDialog openfile = new FileDialog(f,"选择要打开的文件",FileDialog.LOAD);
	 public FileDialog savefile = new FileDialog(f,"选择要保存的文件",FileDialog.SAVE);
