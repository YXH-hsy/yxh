...
public class MenuBars extends Main{
	...
	protected JMenu format = new JMenu("格式(O)");
	...
	// 编辑菜单	
	protected JMenuItem copyItem = new JMenuItem("复制(C)");
	protected JMenuItem poasteItem = new JMenuItem("粘贴(P)");
	JMenuItem findItem = new JMenuItem("查找(F)");
	JMenuItem receItem = new JMenuItem("替换(R)");
	// 格式菜单
	protected JCheckBoxMenuItem wline = new JCheckBoxMenuItem("自动换行(W)...");
	protected JMenuItem fontItem = new JMenuItem("字体(F)...");
	// 帮助菜单、
